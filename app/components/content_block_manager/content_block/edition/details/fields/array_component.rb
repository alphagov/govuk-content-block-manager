class ContentBlockManager::ContentBlock::Edition::Details::Fields::ArrayComponent < ContentBlockManager::ContentBlock::Edition::Details::Fields::BaseComponent
...
private
  ...
  def component(index)
    ContentBlockManager::ContentBlock::Edition::Details::Fields::Array::ItemComponent.new(
      field_name: label,
