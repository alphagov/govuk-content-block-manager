class ContentBlockManager::ContentBlock::Edition
  module Details
    ...
    private
      ...
      def component_for_field(field)
        ...
        component_class = "ContentBlockManager::ContentBlock::Edition::Details::Fields::#{component_name.camelize}Component".constantize
