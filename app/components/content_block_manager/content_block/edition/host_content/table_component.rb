class ContentBlockManager::ContentBlock::Edition::HostContent::TableComponent < ContentBlockManager::ContentBlock::Document::Show::HostEditionsTableComponent
private
  ...
  def frontend_path(content_item)
    helpers.host_content_preview_content_block_manager_content_block_edition_path(id: content_block_edition.id, host_content_id: content_item.host_content_id, locale: content_item.host_locale)
  end
end
