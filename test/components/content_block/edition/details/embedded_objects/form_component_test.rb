...
class ContentBlockManager::ContentBlock::Edition::Details::EmbeddedObjects::FormComponentTest < ViewComponent::TestCase
  ...
  it "renders fields for each property" do
    ContentBlockManager::ContentBlock::Edition::Details::Fields::StringComponent.expects(:new).with(
    ...
    ContentBlockManager::ContentBlock::Edition::Details::Fields::EnumComponent.expects(:new).with(
      content_block_edition:,
      field: enum_field,
      subschema:,
    ...
    ContentBlockManager::ContentBlock::Edition::Details::Fields::TextareaComponent.expects(:new).with(
      content_block_edition:,
      field: textarea_field,
      subschema:,
    ).returns(textarea_stub)

    ContentBlockManager::ContentBlock::Edition::Details::Fields::BooleanComponent.expects(:new).with(
      content_block_edition:,
      field: boolean_field,
      subschema:,
    ).returns(boolean_stub)

    component = ContentBlockManager::ContentBlock::Edition::Details::EmbeddedObjects::FormComponent.new(
      content_block_edition:,
      subschema:,
      params: nil,
    )
