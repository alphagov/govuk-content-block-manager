...
class ContentBlockManager::ContentBlock::Edition::Details::FormComponentTest < ViewComponent::TestCase
  ...
  let(:component) do
    ContentBlockManager::ContentBlock::Edition::Details::FormComponent.new(
