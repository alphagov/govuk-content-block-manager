...
class ContentBlockManager::ContentBlock::Edition::Details::Fields::BooleanComponentTest < ViewComponent::TestCase
  ...
  before do
    render_inline(
      ContentBlockManager::ContentBlock::Edition::Details::Fields::BooleanComponent.new(
