...
class ContentBlockManager::ContentBlock::Edition::Details::Fields::CallChargesComponentTest < ViewComponent::TestCase
  ...
  let(:component) do
    ContentBlockManager::ContentBlock::Edition::Details::Fields::CallChargesComponent.new(
