...
class ContentBlockManager::ContentBlock::Edition::Details::Fields::VideoRelayServiceComponentTest < ViewComponent::TestCase
  ...
  let(:component) do
    ContentBlockManager::ContentBlock::Edition::Details::Fields::VideoRelayServiceComponent.new(
