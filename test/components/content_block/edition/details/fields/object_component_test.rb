...
class ContentBlockManager::ContentBlock::Edition::Details::Fields::ObjectComponentTest < ViewComponent::TestCase
  ...
  let(:component) do
    ContentBlockManager::ContentBlock::Edition::Details::Fields::ObjectComponent.new(
