...
class ContentBlockManager::ContentBlock::Edition::Details::Fields::OpeningHoursComponentTest < ViewComponent::TestCase
  ...
  let(:component) do
    ContentBlockManager::ContentBlock::Edition::Details::Fields::OpeningHoursComponent.new(
