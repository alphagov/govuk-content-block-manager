...
class ContentBlockManager::ContentBlock::Edition::Details::Fields::EnumComponentTest < ViewComponent::TestCase
  ...
  describe "when there is no default value" do
    it "should render a select field with given parameters" do
      render_inline(
        ContentBlockManager::ContentBlock::Edition::Details::Fields::EnumComponent.new(
      ...
      expected_id = "#{ContentBlockManager::ContentBlock::Edition::Details::Fields::BaseComponent::PARENT_CLASS}_details_something"
  ...
  describe "#options" do
    it "returns a list of options" do
      component = ContentBlockManager::ContentBlock::Edition::Details::Fields::EnumComponent.new(
        content_block_edition:,
        field:,
        enum: ["a week", "a month"],
      )
