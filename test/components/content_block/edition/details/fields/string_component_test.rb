...
class ContentBlockManager::ContentBlock::Edition::Details::Fields::StringComponentTest < ViewComponent::TestCase
  ...
  it "should render an input field with default parameters" do
    render_inline(
      ContentBlockManager::ContentBlock::Edition::Details::Fields::StringComponent.new(
    ...
    expected_id = "#{ContentBlockManager::ContentBlock::Edition::Details::Fields::BaseComponent::PARENT_CLASS}_details_email_address"
  ...
  describe "when a subschema is present" do
    ...
    it "should generate the correct name and ID" do
      ...
      expected_id = "#{ContentBlockManager::ContentBlock::Edition::Details::Fields::BaseComponent::PARENT_CLASS}_details_my_suffix_email_address"
