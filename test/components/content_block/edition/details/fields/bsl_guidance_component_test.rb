...
class ContentBlockManager::ContentBlock::Edition::Details::Fields::BSLGuidanceComponentTest < ViewComponent::TestCase
  ...
  let(:component) do
    ContentBlockManager::ContentBlock::Edition::Details::Fields::BSLGuidanceComponent.new(
