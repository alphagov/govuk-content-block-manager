...
class ContentBlockManager::ContentBlock::Edition::Details::Fields::ArrayComponentTest < ViewComponent::TestCase
  ...
  let(:component) do
    ContentBlockManager::ContentBlock::Edition::Details::Fields::ArrayComponent.new(
