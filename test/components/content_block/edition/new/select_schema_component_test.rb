...
class ContentBlockManager::ContentBlock::Edition::New::SelectSchemaComponentTest < ViewComponent::TestCase
  ...
  let(:component) do
    ContentBlockManager::ContentBlock::Edition::New::SelectSchemaComponent.new(
      heading:,
      heading_caption:,
      error_message:,
      schemas:,
