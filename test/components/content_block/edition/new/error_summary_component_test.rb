...
class ContentBlockManager::ContentBlock::Edition::New::ErrorSummaryComponentTest < ViewComponent::TestCase
  extend Minitest::Spec::DSL

  let(:component) do
    ContentBlockManager::ContentBlock::Edition::New::ErrorSummaryComponent.new(error_message:)
  end
