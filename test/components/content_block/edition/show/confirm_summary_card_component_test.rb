...
class ContentBlockManager::ContentBlock::Edition::Show::ConfirmSummaryCardComponentTest < ViewComponent::TestCase
  ...
  it "it renders instructions to publishers" do
    ...
    render_inline(ContentBlockManager::ContentBlock::Edition::Show::ConfirmSummaryCardComponent.new(
