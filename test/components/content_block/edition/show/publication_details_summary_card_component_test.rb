...
class ContentBlockManager::ContentBlock::Edition::Show::PublicationDetailsSummaryCardComponentTest < ViewComponent::TestCase
  ...
  let(:component) do
    ContentBlockManager::ContentBlock::Edition::Show::PublicationDetailsSummaryCardComponent.new(
      content_block_edition:,
    )
  end
