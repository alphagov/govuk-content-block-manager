...
class ContentBlockManager::ContentBlock::Edition::Show::NotesSummaryCardComponentTest < ViewComponent::TestCase
  ...
  let(:component) do
    ContentBlockManager::ContentBlock::Edition::Show::NotesSummaryCardComponent.new(
      content_block_edition:,
    )
  end
