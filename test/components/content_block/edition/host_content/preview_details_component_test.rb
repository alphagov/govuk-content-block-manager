...
class ContentBlockManager::ContentBlock::Edition::HostContent::PreviewDetailsComponentTest < ViewComponent::TestCase
  ...
  it "returns a list of details for preview content" do
    render_inline(
      ContentBlockManager::ContentBlock::Edition::HostContent::PreviewDetailsComponent.new(
