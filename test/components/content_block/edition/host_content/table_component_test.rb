...
class ContentBlockManager::ContentBlock::Edition::HostContent::TableComponentTest < ViewComponent::TestCase
  extend Minitest::Spec::DSL
  include Rails.application.routes.url_helpers

  let(:described_class) { ContentBlockManager::ContentBlock::Edition::HostContent::TableComponent }
