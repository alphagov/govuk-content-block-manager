...
class ContentBlockManager::ContentBlock::Edition::Workflow::GroupComponentTest < ViewComponent::TestCase
  ...
  let(:component) do
    ContentBlockManager::ContentBlock::Edition::Workflow::GroupComponent.new(
